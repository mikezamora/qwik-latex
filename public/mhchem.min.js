    ...
    return (
      (function () {
        ...
        var n = function (t, e) {
            for (
              var n = "",
                o = t.length && t[t.length - 1].loc.start,
                i = t.length - 1;
              i >= 0;
              i--
            )
          ...
          a = {
            ...
            patterns: {
              ...
              findObserveGroups: function (t, e, n, o, a, r, i, c, u, p) {
                ...
                if (((t = t.substr(_.length)), null === (_ = s(t, n))))
                  return null;
            ...
            actions: {
              ...
              "1/2": function (t, e) {
                var n = [];
                e.match(/^[+\-]/) &&
                  (n.push(e.substr(0, 1)), (e = e.substr(1)));
                var o = e.match(
                  /^([0-9]+|\$[a-z]\$|[a-z])\/([0-9]+)(\$[a-z]\$|[a-z])?$/,
                );
                return (
            ...
            createTransitions: function (t) {
              ...
              for (e in t)
                for (n in t[e])
                  for (
                    o = n.split("|"), t[e][n].stateArray = o, a = 0;
                    a < o.length;
                    a++
                  )
                    r[o[a]] = [];
            ...
            actions: {
              ...
              "charge or bond": function (t, e) {
                if (t.beginsWithBond) {
                  var n = [];
                  return (
                    a.concatArray(n, this.output(t)),
                    a.concatArray(n, a.actions.bond(t, e, "-")),
                    n
                  );
                }
                t.d = e;
              ...
              enumber: function (t, e) {
                ...
                return (
                  ...
                  e[1] &&
                    ...
                    e[2] &&
                      (e[2].match(/[,.]/)
                        ? a.concatArray(n, a.go(e[2], "pu-9,9"))
                        : n.push(e[2])),
                    (e[3] = e[4] || e[3]),
                    e[3] &&
                      ((e[3] = e[3].trim()),
        ...
        var r = {
          ...
          _go2: function (t) {
            ...
            switch (t.type_) {
              ...
              case "pu-frac":
                var a =
                  "\\frac{" + r._goInner(t.p1) + "}{" + r._goInner(t.p2) + "}";
                e =
                  "\\mathchoice{\\textstyle" +
                  a +
                  "}{" +
