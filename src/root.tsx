  ...
  `}
        ...
        <div class="p-4">
          <div class="pb-4">
            ...
            <div ref={outputRef}>
              <p>
                {String.raw`$f(x) = \int_{-\infty}^\infty \hat f(\xi)\,e^{2 \pi i \xi x} \, d\xi$`}
              </p>
            </div>
            <LaTeX
              options={{}}
              shouldRenderMathInElement
          ...
          <div class="pb-4">
            ...
            <p id={elementId}>
              {String.raw`$\displaystyle \frac{1}{\Bigl(\sqrt{\phi \sqrt{5}}-\phi\Bigr) e^{\frac25 \pi}} = 1+\frac{e^{-2\pi}} {1+\frac{e^{-4\pi}} {1+\frac{e^{-6\pi}} {1+\frac{e^{-8\pi}} {1+\cdots} } } }$
        $\displaystyle \left( \sum_{k=1}^n a_k b_k \right)^2 \leq \left( \sum_{k=1}^n a_k^2 \right) \left( \sum_{k=1}^n b_k^2 \right)$`}
          ...
          <div class="pb-4">
            ...
            <LaTeX options={{}} shouldRenderMathInElement>
              <p>
                {String.raw`$\displaystyle {1 +  \frac{q^2}{(1-q)}+\frac{q^6}{(1-q)(1-q^2)}+\cdots }= \prod_{j=0}^{\infty}\frac{1}{(1-q^{5j+2})(1-q^{5j+3})}, \quad\quad \text{for }\lvert q\rvert<1.$`}
              </p>
            </LaTeX>
          </div>
        </div>
        ...
        <div class="flex p-4">
          <LaTeX options={{}} shouldRenderMathInElement>
            <p>{String.raw`$C_p[\ce{H2O(l)}] = \pu{75.3 J // mol K}$`}</p>
          </LaTeX>
